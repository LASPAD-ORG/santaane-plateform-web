export default function getFormattersTemplate(featureName, featureNamePascal) {
  return `/**
 * Format date for ${featureName} display
 */
export function format${featureNamePascal}Date(dateString: string): string {
