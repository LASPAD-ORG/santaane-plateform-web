...
/**
 * GET /api/manuscripts/{id}/annotations
 * Retrieve all annotations for a manuscript
 */
export async function GET(
  ...
  try {
    ...
    const response = await axios.get(
      `${BACKEND_URL}/api/v1/manuscripts/${id}/annotations`,
      {
        headers: {
...
/**
 * POST /api/manuscripts/{id}/annotations
