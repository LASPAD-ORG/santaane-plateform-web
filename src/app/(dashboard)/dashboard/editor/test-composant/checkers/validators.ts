...
// Payload interface for creating/updating lamine-composant-big-seydou-tekiya-saliou-allan
export interface LamineComposantBigSeydouTekiyaSaliouAllanPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete lamine-composant-big-seydou-tekiya-saliou-allan payload
 */
export function validateLamineComposantBigSeydouTekiyaSaliouAllan(payload: LamineComposantBigSeydouTekiyaSaliouAllanPayload): ValidationError[] {
...
/**
 * Check if user can edit this lamine-composant-big-seydou-tekiya-saliou-allan
 */
export function canEditLamineComposantBigSeydouTekiyaSaliouAllan(
  itemOwnerId: string,
...
/**
 * Check if user can delete this lamine-composant-big-seydou-tekiya-saliou-allan
 */
export function canDeleteLamineComposantBigSeydouTekiyaSaliouAllan(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this lamine-composant-big-seydou-tekiya-saliou-allan
 */
export function canViewLamineComposantBigSeydouTekiyaSaliouAllan(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
