/**
 * Format date for lamine-composant-big-seydou-tekiya-saliou-allan display
 */
export function formatLamineComposantBigSeydouTekiyaSaliouAllanDate(dateString: string): string {
