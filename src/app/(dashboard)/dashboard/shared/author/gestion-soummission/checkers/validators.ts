...
// Payload interface for creating/updating gestion-soummission
export interface GestionSoummissionPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-soummission payload
 */
export function validateGestionSoummission(payload: GestionSoummissionPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-soummission
 */
export function canEditGestionSoummission(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-soummission
 */
export function canDeleteGestionSoummission(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-soummission
 */
export function canViewGestionSoummission(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
