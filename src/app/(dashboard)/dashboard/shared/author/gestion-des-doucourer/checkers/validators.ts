...
// Payload interface for creating/updating gestion-des-doucourer
export interface GestionDesDoucourerPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-des-doucourer payload
 */
export function validateGestionDesDoucourer(payload: GestionDesDoucourerPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-des-doucourer
 */
export function canEditGestionDesDoucourer(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-des-doucourer
 */
export function canDeleteGestionDesDoucourer(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-des-doucourer
 */
export function canViewGestionDesDoucourer(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
