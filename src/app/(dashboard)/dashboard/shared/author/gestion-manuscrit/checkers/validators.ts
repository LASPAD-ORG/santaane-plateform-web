...
// Payload interface for creating/updating gestion-manuscrit
...
/**
 * Validate complete gestion-manuscrit payload
 */
export function validateGestionManuscrit(payload: GestionManuscritPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-manuscrit
 */
export function canEditGestionManuscrit(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-manuscrit
 */
export function canDeleteGestionManuscrit(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-manuscrit
 */
export function canViewGestionManuscrit(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
