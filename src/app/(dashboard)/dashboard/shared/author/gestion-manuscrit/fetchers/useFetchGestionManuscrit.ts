...
// Define the gestion-manuscrit item interface
export interface GestionManuscritItem {
  id: string;
  title: string;
  description?: string;
  status: string;
...
const MOCK_DATA: GestionManuscritItem[] = [
  {
    id: '1',
    title: 'Exemple 1',
    description: 'Ceci est un exemple de gestion-manuscrit',
    status: 'published',
  ...
  },
  {
    id: '2',
    title: 'Exemple 2',
    description: 'Un autre exemple de gestion-manuscrit',
    status: 'draft',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    authorId: 'user-1',
  },
  {
    id: '3',
    title: 'Exemple 3',
    description: 'Encore un exemple de gestion-manuscrit',
    status: 'pending',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    authorId: 'user-2',
