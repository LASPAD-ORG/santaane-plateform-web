...
export default function InternalEvaluatorDashboardContent() {
  ...
  if (error) {
    return <Alert severity="error">Erreur lors du chargement du dashboard évaluateur interne : {error.message}</Alert>;
  }
  if (!data) {
