...
// Payload interface for creating/updating gestion-mentor
export interface GestionMentorPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-mentor payload
 */
export function validateGestionMentor(payload: GestionMentorPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-mentor
 */
export function canEditGestionMentor(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-mentor
 */
export function canDeleteGestionMentor(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-mentor
 */
export function canViewGestionMentor(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
