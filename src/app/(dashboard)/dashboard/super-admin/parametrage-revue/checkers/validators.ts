...
// Payload interface for creating/updating parametrage-revue
export interface ParametrageRevuePayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete parametrage-revue payload
 */
export function validateParametrageRevue(payload: ParametrageRevuePayload): ValidationError[] {
...
/**
 * Check if user can edit this parametrage-revue
 */
export function canEditParametrageRevue(
  itemOwnerId: string,
...
/**
 * Check if user can delete this parametrage-revue
 */
export function canDeleteParametrageRevue(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this parametrage-revue
 */
export function canViewParametrageRevue(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
