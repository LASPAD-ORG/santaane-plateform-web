...
// Payload interface for creating/updating gestion-des-editeur
export interface GestionDesEditeurPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-des-editeur payload
 */
export function validateGestionDesEditeur(payload: GestionDesEditeurPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-des-editeur
 */
export function canEditGestionDesEditeur(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-des-editeur
 */
export function canDeleteGestionDesEditeur(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-des-editeur
 */
export function canViewGestionDesEditeur(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
