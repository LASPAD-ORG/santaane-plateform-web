...
// Payload interface for creating/updating test-page
...
/**
 * Validate complete test-page payload
 */
export function validateTestPage(payload: TestPagePayload): ValidationError[] {
...
/**
 * Check if user can edit this test-page
 */
export function canEditTestPage(
  itemOwnerId: string,
...
/**
 * Check if user can delete this test-page
 */
export function canDeleteTestPage(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this test-page
 */
export function canViewTestPage(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
