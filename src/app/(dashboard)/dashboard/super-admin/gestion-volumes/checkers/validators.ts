...
// Payload interface for creating/updating gestion-volumes
export interface GestionVolumesPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-volumes payload
 */
export function validateGestionVolumes(payload: GestionVolumesPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-volumes
 */
export function canEditGestionVolumes(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-volumes
 */
export function canDeleteGestionVolumes(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-volumes
 */
export function canViewGestionVolumes(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
