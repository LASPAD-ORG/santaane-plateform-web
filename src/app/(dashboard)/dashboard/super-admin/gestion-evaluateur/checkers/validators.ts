...
// Payload interface for creating/updating gestion-evaluateur
export interface GestionEvaluateurPayload {
  title: string;
  description?: string;
  status?: string;
...
/**
 * Validate complete gestion-evaluateur payload
 */
export function validateGestionEvaluateur(payload: GestionEvaluateurPayload): ValidationError[] {
...
/**
 * Check if user can edit this gestion-evaluateur
 */
export function canEditGestionEvaluateur(
  itemOwnerId: string,
...
/**
 * Check if user can delete this gestion-evaluateur
 */
export function canDeleteGestionEvaluateur(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
...
/**
 * Check if user can view this gestion-evaluateur
 */
export function canViewGestionEvaluateur(
  itemOwnerId: string,
  currentUserId: string,
  userRoles: string[]
): boolean {
